...
export const premiumFeatures = [
	...
	{
		code: 'body_weight_tracking',
		name: 'Body Tracking',
		category: 'Health',
		active: true,
	},
	{
		code: 'workout_progress',
...
export const roleCards: Array<{ role: RoleCode; summary: string }> = [
	{
		role: 'OWNER',
		summary: 'Full business control, financial, branding, roles.',
	},
	{
		role: 'ADMIN',
		summary: 'Daily operations: members, invoices, payments, attendance.',
	},
	{
		role: 'MEMBER',
		summary: 'Portal, billing, check-in, and plan-based premium features.',
	},
];
