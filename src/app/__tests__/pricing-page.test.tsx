	...
	describe('saat user TIDAK login', () => {
		...
		it('4. menampilkan semua paket dengan nama dan durasi', async () => {
			...
			for (const plan of mockPlans) {
				...
				expect(
					screen.getAllByText(`${plan.duration_days} hari akses`).length,
